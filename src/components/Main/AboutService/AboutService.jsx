...
import about_picture from "../../../images/about_picture.svg"

function AboutService({ isLoggedIn }) {
    ...
    return (
        <div className="about-block">
            <div className="about-info-block">
                ...
                <p className="about-p-box">Комплексный анализ публикаций, получение данных в формате PDF на электронную
                    почту.</p>
                {isLoggedIn && <button
                    className="button"
