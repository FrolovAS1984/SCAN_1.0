...
function DocumentCount ({ documentCount , setDocumentCount }) {
    ...
    return (
        <div className="form-field form-field-inputs">
            <label htmlFor="documentCount">Количество документов в выдаче <span
                className={ error ? "required-asterisk error" : "required-asterisk" }>*</span></label>
            <input
                type="number"
                id="documentCount"
                name="documentCount"
