...
import search_large_picture from "../../images/search_large_picture.svg"
import search_small_picture_folders from "../../images/search_small_picture_folders.svg"
import search_small_picture_sheet from "../../images/search_small_picture_sheet.svg"
        ...
        <div className="search-content">
            ...
            <div className="search-title-block">
                <div className="search-title-text">
                    ...
                    <p className="p-search-page-title-block">Задайте параметры поиска. <br/>Чем больше заполните, тем
                        точнее поиск</p>
                </div>
                <img className="search-page-small-picture-sheet" src={ search_small_picture_sheet }
                     alt="Paper image"/>
                <img className="search-page-small-picture-folders" src={ search_small_picture_folders }
                     alt="Folderds image"/>
            </div>
            ...
            <div className="search-block">
                <form onSubmit={ handleSubmit } className="search-form">
                    ...
                    <div className="left-part-search-form">
                        ...
                        <DateInput startDate={ startDate } setStartDate={ setStartDate } endDate={ endDate }
                ...
                <img className="search-page-large-picture" src={ search_large_picture } alt="Search image"/>
            </div>
        </div>
    );
};
