...
function ResultTable ({ searchData , isLoading , isError }) {
    ...
    return (
        <div className="general-summary-block">
            ...
            <p className="p-general-summary-title-block">Найдено { totalDataCount } вариантов</p>
                    ...
                    <div className="table-wrapper" ref={ tableWrapperRef }>
                        { isLoading ? (
                            ...
                            <div className="table-data-error">
                                <p className="error-500-message">Ошибка сервера. Попробуйте чуть позже или проверьте
                                    свой тариф.</p>
                            </div>
                        ) : (
