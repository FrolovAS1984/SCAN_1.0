    ...
    useEffect ( () => {
        const fetchSearchResults = async () => {
            ...
            try {
                ...
                const histogramResponse = await fetch ( `${BaseUrl}/objectsearch/histograms` , {
                    method : 'POST' ,
                    headers : {
                ...
                const publicationIdsResponse = await fetch ( `${BaseUrl}/objectsearch` , {
                    method : 'POST' ,
                    headers : {
                        'Content-Type' : 'application/json' ,
                        'Authorization' : `Bearer ${ localStorage.getItem ( 'accessToken' ) }` ,
        ...
        <div className="search-results-content">
            { isLoading && (
                <>
                    ...
                    <ResultTable searchData={ searchData } isLoading={ isLoading }
